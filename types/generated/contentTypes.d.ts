...
export interface ApiEpisodeEpisode extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String;
    tmdb_average_rating: Schema.Attribute.Decimal;
...
export interface ApiGenreGenre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::genre.genre'> &
      Schema.Attribute.Private;
    media: Schema.Attribute.Relation<'manyToMany', 'api::media.media'>;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiJournalEntryJournalEntry
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    media_item: Schema.Attribute.Relation<'manyToOne', 'api::media.media'>;
    my_rating: Schema.Attribute.Decimal &
    ...
    notes_reflections: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    quotes: Schema.Attribute.Relation<'oneToMany', 'api::quote.quote'>;
    season_number: Schema.Attribute.Integer;
    special_moments: Schema.Attribute.Relation<
      'oneToMany',
      'api::special-moment.special-moment'
    >;
    ...
    watched_date: Schema.Attribute.Date;
  };
}
...
export interface ApiMediaMedia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cast: Schema.Attribute.Relation<'manyToMany', 'api::person.person'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    episodes: Schema.Attribute.Relation<'oneToMany', 'api::episode.episode'>;
    franchise: Schema.Attribute.Relation<
      'manyToOne',
      'api::franchise.franchise'
    >;
    genres: Schema.Attribute.Relation<'manyToMany', 'api::genre.genre'>;
    is_ongoing: Schema.Attribute.Boolean;
    journal_entries: Schema.Attribute.Relation<
      'oneToMany',
      'api::journal-entry.journal-entry'
    >;
    last_air_date: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::media.media'> &
      Schema.Attribute.Private;
    number_of_seasons: Schema.Attribute.Integer;
    poster_path: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    quotes: Schema.Attribute.Relation<'oneToMany', 'api::quote.quote'>;
    release_status: Schema.Attribute.Enumeration<['released', 'upcoming']>;
    ...
    type: Schema.Attribute.Enumeration<['movies', 'tv_series']>;
    upcoming_release_date: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cast_in: Schema.Attribute.Relation<'manyToMany', 'api::media.media'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSpecialMomentSpecialMoment
  extends Struct.CollectionTypeSchema {
